...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container p-md-4 p-sm-4">
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            <div class="col-md-8">
                ...
                <asp:TextBox ID="txtName" runat="server" CssClass="from-control" placeholder="Enter Name"
            ...
            <div class="col-md-6">
                <label for="txtDoB">Data of Birth</label>
                <asp:TextBox ID="txtDoB" runat="server" CssClass="from-control" TextMode="Date"
                    required></asp:TextBox>
            </div>
        </div>
     ...
     <div class="col-md-8">
         ...
         <asp:DropDownList ID="ddlGender" runat="server" CssClass="from-control">
     ...
     <div class="col-md-6">
         ...
         <asp:TextBox ID="txtMobile" runat="server" CssClass="from-control" TextMode="Number" placeholder="10 digits Mobile No."
             required></asp:TextBox>
   ...
   <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
      <div class="col-md-8">
          ...
          <asp:TextBox ID="txtEmail" runat="server" CssClass="from-control" placeholder="Enter Email" TextMode="Email"
                      required></asp:TextBox>       
      </div>
      <div class="col-md-6">
          <label for="txtPassword">Password</label>
          <asp:TextBox ID="txtPassword" runat="server" CssClass="from-control" placeholder="Enter Password" TextMode="Password"
              required></asp:TextBox>
      </div>
  </div>
   ...
   <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
      <div class="col-md-12">
          ...
          <asp:TextBox ID="txtAddress" runat="server" CssClass="from-control" placeholder="Enter Address" TextMode="MultiLine"
                      required></asp:TextBox>       
      </div>
  </div>
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5">
             <div class="col-md-6">
                 <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" AutoGenerateColumns="False" 
                     ...
                     OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" PageSize="4" DataKeyNames="TeacherId" OnRowDeleting="GridView1_RowDeleting">
                     <Columns>
