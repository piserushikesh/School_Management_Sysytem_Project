    ...
    <div class="container p-md-4 p-sm-4">
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5 mt-md-5">
            ...
            <div class="col-md-6">
                ...
                <asp:TextBox ID="txtSubject" runat="server" CssClass="from-control" placeholder="Enter Subject"
        ...
        <div class="row mb-3 mr-lg-5 ml-lg-5">
             <div class="col-md-6">
                 <asp:GridView ID="GridView1" runat="server" CssClass="table table-hover table-bordered" AutoGenerateColumns="False" 
                     ...
                     OnRowEditing="GridView1_RowEditing" OnRowUpdating="GridView1_RowUpdating" PageSize="4" DataKeyNames="SubjectId">
                     <Columns>
